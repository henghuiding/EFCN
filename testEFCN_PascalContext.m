function accuracy = testEFCN_PascalContext()
run(fullfile(fileparts(mfilename('fullpath')), '../matconvnet-1.0-beta21/matlab/vl_setupnn.m')) ;
...
netFn{end+1} = sprintf('PascalContext_%d_Val/DenseSkip-ifcn8s-3x3-8layers-1024-1e-3-higher3/net-BN-val.mat', imageSize); 
