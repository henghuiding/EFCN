...
if opts.save
    ...
    resultFolder = fullfile(baseDir, 'results/unaryPredictions/IFCN-VOC-val7997');
...
netFn = {};
% dir of net model
netFn{end+1} = sprintf('PascalVOC_%d_COCO/batch-coco-ifcn8s-5x5-6layers-1e-3-higher3/net-BN-val.mat', 512); 
